...
app.get('/', (c) => {
  ...
  return c.html(`
    ...
    <body class="hero">
        ...
        <main class="main-panel">
          ...
          <div class="title-block">
            ...
            <div class="stats">
              ...
              <span>Upstream - ${remoteProxyInfo.baseUrl}</span>
          ...
          <div class="model-strip">
            ...
            <div class="model-buttons" id="modelButtons">
              ...
              <button
                ...
                data-proxy="${remoteProxyInfo.baseUrl}"
            ...
            <div class="endpoint-control">
              ...
              <input id="endpointInput" type="text" value="${remoteProxyInfo.baseUrl}" placeholder="Override backend URL (optional)" />
      ...
      <script id="app-config" type="application/json">${JSON.stringify(uiConfig)}</script>
...
app.post('/api/query', async (c) => {
  ...
  try {
    ...
    pushTrim(history, createMessage('user', query));

    pushTrim(history, createMessage('assistant', result.answer));
